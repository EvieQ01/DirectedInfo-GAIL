...
def get_div_from_all_traj_continuous(all_traj, delta_t=10, neighbor_k=10):
    '''
    input: list of (x, y), (N, L, 2) 
    ...
    # [2] divergence
    div = get_max_dist_for_all_states(all_traj=all_traj, delta_t=delta_t, neighbor_k=neighbor_k)
    # hist = np.histogram(a=all_entropy, bins=np.arange(0, 1, 0.1))
    # print(hist)
    # plot_entropy()
    # pdb.set_trace()
